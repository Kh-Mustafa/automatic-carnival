...
int assemble_account_number(int secret_modifier){
    int assAccNum;
    assAccNum = zhang::bank_number_part(secret_modifier) + khan::bank_number_part(secret_modifier) + garcia::bank_number_part(secret_modifier);
    return assAccNum;
}
int assemble_code(){
    int secretAss;
    ...
    togrutaAss = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();

    asariAss = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();

    secretAss = togrutaAss * asariAss;
